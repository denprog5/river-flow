...
describe('Strings case conversion', function () {
    it('handles ASCII strings', function () {
    ...
    it('is mbstring-aware for non-ASCII strings when mbstring is available', function () {
